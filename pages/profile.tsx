...
export const profile = ({csrfToken}) => {
...
return null
    ...
    //       Email Address:
    //     </label>
    //     <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="name" id="email" type="text" placeholder="Email Address"/>
    //   </div>
    //   <div className="mb-6">
    //     <label className="block text-gray-700 text-md tracking-wider font-semibold mb-2" htmlFor="password">
    //       Password:
    //     </label>
    //     <input className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 text-xs leading-tight focus:outline-none focus:shadow-outline" name="name" id="password" type="password" placeholder="******************"/>
